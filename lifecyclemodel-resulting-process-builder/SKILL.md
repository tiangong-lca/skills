...
1. By default the wrapper runs the exact published CLI through `pnpm dlx --package=@tiangong-lca/cli@0.1.14 tiangong-lca`. Use `TIANGONG_LCA_CLI_DIR` or `--cli-dir` only for local dev/CI overrides.
