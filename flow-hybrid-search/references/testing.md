...
```bash
pnpm dlx --package=@tiangong-lca/cli@0.1.14 tiangong-lca auth doctor-auth --json
...
```bash
pnpm dlx --package=@tiangong-lca/cli@0.1.14 tiangong-lca search flow --input ./assets/example-request.json --dry-run --json
```
